...
void	ft_putimages(t_data *game)
{
	...
	while (game->map[game->mat_y])
	{
		...
		{
			mlx_put_image_to_window(game->mlx, game->mlx_window, game->img[1], game->mat_x * 64, game->mat_y * 64);
			if (game->map[game->mat_y][game->mat_x] == '1')
                mlx_put_image_to_window(game->mlx, game->mlx_window, game->img[2], game->mat_x * 64, game->mat_y * 64);
			...
			{
				mlx_put_image_to_window(game->mlx, game->mlx_window, game->img[3], game->mat_x * 64, game->mat_y * 64);
				game->coin++;
			}
